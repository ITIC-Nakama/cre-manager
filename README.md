...
*   🧪 **[Couverture & Architecture des Tests (`docs/TEST_COVERAGE.md`)](./docs/TEST_COVERAGE.md)** : Architecture de test automatisée, matrice de couverture intégrale (168 tests d'intégration sur 16 modules), exécution CI/CD dans GitHub Actions.
...
Le backend inclut **168 tests unitaires et d'intégration** couvrant 100% des modules fonctionnels (Authentification, Gouvernance Admin, CRM, CV, JPA Specifications, Gamification, Skill Tree, Jobboard, RGPD, Audit, Dashboard, Configuration Applicative, Stockage Fichiers et Emails).
