...
public enum MessageKey {
    ...
    PASSWORD_RESET_STUDENTS_ONLY("password-reset-students-only",
            "La réinitialisation par OTP est réservée aux étudiants et aux administrateurs",
            "Password reset via OTP is only available for students and administrators"),
    ...
    JOB_OFFER_WIPED("job-offer-wiped", "Offres supprimées avec succès", "Job offers wiped successfully"),
    JOB_OFFER_WIPE_INVALID_SCOPE("job-offer-wipe-invalid-scope", "Portée invalide : MANUAL, EXTERNAL ou ALL attendu", "Invalid scope: expected MANUAL, EXTERNAL or ALL"),
    ...
    APPLICATION_CREATED_BY_ADVISOR_LOCKED("application-created-by-advisor-locked", "Cette candidature a été créée par votre conseiller, vous ne pouvez pas la supprimer", "This application was created by your advisor, you cannot delete it"),
    ...
    CV_FILE_TOO_LARGE("cv-file-too-large", "Le fichier CV dépasse la taille maximale autorisée", "CV file exceeds the maximum allowed size"),
    IMAGE_FILE_TOO_LARGE("image-file-too-large", "L'image dépasse la taille maximale autorisée", "Image exceeds the maximum allowed size"),
