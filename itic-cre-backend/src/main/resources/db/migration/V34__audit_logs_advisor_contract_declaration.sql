-- Ajoute APPLICATION_CONTRACT_DECLARED_BY_ADVISOR a la contrainte CHECK de audit_logs.action
-- (voir AuditAction.java). Meme piege que V27 : oublier de reconstruire cette contrainte quand
-- l'enum gagne une nouvelle valeur fait echouer l'insertion de l'audit log des le premier appel.
