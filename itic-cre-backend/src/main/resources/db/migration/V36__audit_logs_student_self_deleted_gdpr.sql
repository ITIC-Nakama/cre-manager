-- Ajoute STUDENT_SELF_DELETED_GDPR a la contrainte CHECK de audit_logs.action (voir AuditAction.java).
-- Distingue une auto-suppression de compte (RGPD) de USER_DEACTIVATED, jusque-la utilise aussi bien
-- pour une auto-suppression que pour une desactivation manuelle par un admin ou la purge automatique.
