...
import StudentCard from './candidatures/StudentCard';
import StudentDrawer from './candidatures/StudentDrawer';
import type { StudentGroup } from './candidatures/types';
        ...
        <div className="flex flex-col gap-6 animate-fadeIn">
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                <CustomSelect
                    ...
                    onChange={handleFilter(setPromotionFilter)}
                ...
                <CustomSelect
                    ...
                    onChange={handleFilter(setContractTypeFilter)}
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-24 gap-3 text-slate-400">
                    ...
                    <p className="font-medium text-slate-600 dark:text-slate-400">Aucun étudiant actif avec des candidatures</p>
                    <p className="text-sm">Modifiez vos filtres pour élargir la recherche.</p>
                </div>
            ) : (
                <>
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-between px-2 text-sm">
                            <span className="text-slate-500 dark:text-slate-400">
                                Page {page + 1} sur {totalPages} — {totalStudents} étudiant{totalStudents > 1 ? 's' : ''}
                            </span>
