export const AUDIT_ACTION_COLORS: Record<string, string> = {
    ...
    JOB_OFFER_CREATED: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30',
    JOB_OFFER_UPDATED: 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30',
    JOB_OFFER_DELETED: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30',
