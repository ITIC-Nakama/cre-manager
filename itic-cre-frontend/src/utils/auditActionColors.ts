export const AUDIT_ACTION_COLORS: Record<string, string> = {
    ...
    PROMOTION_CREATED: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30',
    PROMOTION_UPDATED: 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30',
    PROMOTION_DELETED: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30',
    STUDENT_REMOVED_FROM_PROMOTION: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30',
    STUDENT_ASSIGNED_TO_PROMOTION: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30',
    STUDENT_ASSIGNED_TO_ADVISOR: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30',
    STUDENT_REMOVED_FROM_ADVISOR: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30',
    ...
    APPLICATION_CONTRACT_DECLARED_BY_ADVISOR: 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30',
    APPLICATION_CONTRACT_VALIDATED: 'text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30',
    APPLICATION_CONTRACT_INVALIDATED: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30',
