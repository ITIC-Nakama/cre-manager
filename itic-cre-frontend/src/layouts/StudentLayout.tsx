  ...
  return (
    <RequireAuth allowedRoles={[Role.STUDENT]} redirectTo="/supervisor/dashboard">
      <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <main className="flex-1 overflow-y-auto h-full lg:pl-0 pt-12 lg:pt-0">
          <div className="max-w-screen-xl mx-auto px-4 pt-2 pb-6 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
            <Outlet />
          </div>
        </main>
      </div>
